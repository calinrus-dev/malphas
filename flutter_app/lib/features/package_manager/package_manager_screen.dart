...
class _PackageManagerPanelState extends State<PackageManagerPanel> {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Text('Static structures mapped in ../packages/',
                      style: TextStyle(
                          fontFamily: 'Arial',
                          fontSize: 11,
              ...
              child: Column(
                ...
                children: [
                  Text(pack.name,
                      ...
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis),
                  Text('${pack.version} • ${filtered.length} Blocks Detected',
                      style: const TextStyle(
                          fontFamily: 'Arial',
                          fontSize: 11,
                          color: Colors.white24),
  ...
  Widget _buildMutatedContent(List<MalphasObject> objects, ThemeData theme) {
    if (objects.isEmpty) {
      return const Center(
          child: Text('No entity matches the selected filter.',
              style: TextStyle(
                  fontFamily: 'Arial', color: Colors.white24, fontSize: 12)));
    }
        ...
        return Container(
          ...
          child: ListTile(
            title: Text(obj.name,
                ...
                maxLines: 1,
                overflow: TextOverflow.ellipsis),
            subtitle: Text('Pointer ID: ${obj.id}',
                style: const TextStyle(
                    fontFamily: 'Courier', fontSize: 10, color: Colors.white24),
                maxLines: 1,
                overflow: TextOverflow.ellipsis),
            trailing: Icon(Icons.unfold_more_sharp,
        ...
        return Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('FILTER BY TAG COVERAGE',
                    style: TextStyle(
                        fontFamily: 'Arial',
                        fontSize: 10,
                        color: Colors.white38,
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('TECHNICAL PROPERTIES:',
                      style: TextStyle(
                          fontFamily: 'Arial',
                          fontSize: 9,
                          color: Colors.white24,
                  ...
                  const Text('GRAPHICAL BEHAVIOR VARIANTS:',
                      style: TextStyle(
                          fontFamily: 'Arial',
                          fontSize: 9,
                          color: Colors.white24,
