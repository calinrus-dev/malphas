  ...
  void _scanDirectory(String path) {
    ...
    try {
      ...
      if (dir.existsSync()) {
        ...
        // Check for MSP/MXC files inside packages/ directory or root directory
            ...
            for (final entity in targetDir.listSync()) {
              if (entity is File) {
                ...
                if (name.toLowerCase().endsWith('.msp')) {
                  msp++;
                  names.add(name);
                } else if (name.toLowerCase().endsWith('.mxc')) {
                  mxc++;
                  names.add(name);
                }
              }
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'MSP Source Packs Found: $_mspCount',
                      style: const TextStyle(
                          fontFamily: 'Courier',
                          color: Colors.white70,
                          fontSize: 11),
                    ...
                    Text(
                      'MXC Executables Found: $_mxcCount',
                      style: const TextStyle(
                          fontFamily: 'Courier',
                          color: Colors.white70,
                          fontSize: 11),
              ...
              if (_foundFiles.isEmpty)
                Container(
                  ...
                  child: const Text(
                    'No .msp or .mxc files detected in this folder.',
                    style: TextStyle(
