[
    ...
    "advice", "aerobic", "affair", "afford", "afraid", "after", "afternoon", "again",
    ...
    "bridge", "brief", "bright", "brisk", "broad", "broccoli", "broken", "bronze",
    ...
    "chase", "chat", "cheap", "check", "cheese", "chef", "cherry", "chess",
    ...
    "coach", "coast", "coconut", "code", "coffee", "coil", "coin", "coke",
    "cold", "collapse", "collar", "collect", "color", "column", "combine", "come",
    "comedy", "comfort", "comic", "command", "comment", "common", "company", "concert",
    "conduct", "confirm", "connect", "consent", "consider", "control", "convert", "cook",
    "cool", "copper", "copy", "coral", "core", "corn", "correct", "cost",
    "cotton", "couch", "cough", "could", "council", "count", "country", "couple",
    "courage", "course", "court", "cousin", "cover", "cow", "crack", "cradle",
    "craft", "crash", "crater", "crawl", "crazy", "cream", "credit", "creek",
    "crew", "cricket", "crime", "crisp", "critic", "crop", "cross", "crowd",
